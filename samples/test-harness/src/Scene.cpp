 ...
 */
bool CreateVertexBuffer(D3D12Global &d3d, ID3D12Resource** vertexBuffer, D3D12_VERTEX_BUFFER_VIEW &view, RuntimeMesh &mesh)
{
 ...
 */
bool CreateIndexBuffer(D3D12Global &d3d, ID3D12Resource** indexBuffer, D3D12_INDEX_BUFFER_VIEW &view, RuntimeMesh &mesh)
{
