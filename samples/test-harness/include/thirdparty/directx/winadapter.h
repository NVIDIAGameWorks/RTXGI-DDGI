...
// These #defines prevent the idl-generated headers (like d3d12.h) from trying to include
...
#define DECLSPEC_UUID(x)        // used with existing UUID emulation
#define DECLSPEC_NOVTABLE     // used with existing UUID emulation
...
// DEFINE_GUID() used by d3d12.h, etc
#ifdef INITGUID
...
#else
// Other stuff from DirectXTex WinAdapter.h
#endif
